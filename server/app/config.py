...
class Config(BaseSettings):
    ...
    DB_PATH: str = str((Path(__file__).resolve().parent / "qualAI.db"))
    ...
    GEMINI_API_URL: str = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent"
