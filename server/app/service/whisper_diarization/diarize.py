...
from app.service.whisper_diarization.helpers import (
    cleanup,
...
def transcribe_and_diarize(
    ...
    if diarizer == "msdd":
        from app.service.whisper_diarization.diarization import MSDDDiarizer
    ...
    srt_output_path = f"{os.path.splitext(audio_path)[0]}.srt"
